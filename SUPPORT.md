...
- **Bug reports** — first look within a few days. Reproducible bugs with
  logs usually get a fix or a workaround within a week.
- **Feature requests** — I read everything, but only implement a fraction.
  The more focused your request, the better its odds.
- **Questions** — best answered by Discussions; issues are for trackable
  work.

## Self-help

- [README.md](README.md) — feature tour and first-time flow
