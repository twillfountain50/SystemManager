...
public static class TargetPresets
{
    ...
    public static readonly TargetPreset CS2Europe = new(
        "CS2 Europe",
        "Valve matchmaking servers across EU — verified pingable IPs.",
        new (string, string)[]
        {
            ...
            ("CS2 EU West 1",     "155.133.246.1"),
            ("CS2 EU West 2",     "155.133.248.1"),
            ("CS2 EU Central",    "162.254.197.1"),
            ("CS2 EU East",       "155.133.254.1"),
        });
    ...
    public static readonly TargetPreset FaceitEurope = new(
        "FACEIT Europe",
        "FACEIT CS2 competitive servers — verified pingable IPs.",
        new (string, string)[]
        {
